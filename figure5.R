...
wp_perm_test$Wind.Potential <- 2000
...
## Save as a PDF
ggsave('/Users/yiannabekris/Documents/energy_data/figures/pdfs/wp_solid_ridges_perm_test.pdf',
       width = 9,
       height = 6, units = c("in"))
...
solar %>%
  ...
  labs(
    ...
    y = "NERC Region",
    title = "Solar Potential by Event Type",
    subtitle = "1980-2021"
  ) +
  facet_wrap(. ~Season) +
  theme(
