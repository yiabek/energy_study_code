...
anom15 = np.load("/Users/yiannabekris/Documents/energy_data/nparrays/tmax_anom15_1979_2021.npy")
datatime = np.load('/Users/yiannabekris/Documents/energy_data/nparrays/tmax_datatime_1979_2021.npy',allow_pickle=True)
cdd = np.load('/Users/yiannabekris/Documents/energy_data/nparrays/cdd_1980_2021.npy')
...
titles=['(e) Standardized Temperature Anomaly', '(f) Cooling Degree Days',
        '(g) Windspeed Anomaly', '(h) Solar Radiation Anomaly']
...
for ind in np.arange(0,len(data_list)):
    ...
    ax.set_title(titles[ind], color='indianred', pad=9, fontdict={'fontsize': 23, 'fontweight': 'bold'})
    ax.add_geometries(new_geometries, facecolor='None', linewidth=4, edgecolor='black',crs=crs)
