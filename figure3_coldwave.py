...
titles = ['(h) Standardized Temperature Anomaly','(i) Windspeed Anomaly', '(j) Solar Radiation Anomaly']
...
for ind in np.arange(0,len(data_list)):
    ...
    ax.set_title(titles[ind], color="royalblue", pad=6, fontdict={'fontsize': 19, 'fontweight': 'bold'})
